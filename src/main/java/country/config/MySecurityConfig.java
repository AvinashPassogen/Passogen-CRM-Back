...
public class MySecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception{
        ...
        .antMatchers("/findleads").permitAll()
        ...
        .antMatchers("/api/insertSales").permitAll()
        .antMatchers("/api/sales/{sid}").permitAll()
        ...
        .antMatchers("/api/leadcount").permitAll()
        .antMatchers("/api/accountCount").permitAll()
        .antMatchers("/api/contactCount").permitAll()
        .antMatchers("/api/countTask").permitAll()
        .antMatchers("/api/countOppo").permitAll()
        .antMatchers("/api/allcountTask").permitAll()
        .antMatchers("/api/TotalSales").permitAll()
