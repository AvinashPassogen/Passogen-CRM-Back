...
public class Contactscontroller {
	...
	private ContactService service;
	 ...
	 @GetMapping("/Contacts")
	  public ResponseEntity<List<Contacts>> getAllTutorials(@RequestParam(required = false) String account) {
	    try {
	      ...
	      if (account == null)
	    	  ...
	    	  ContactsRepository.findByAccountContaining(account).forEach(tutorials::add);
