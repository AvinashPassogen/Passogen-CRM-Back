...
public class LeadsController {
	    ...
	    @GetMapping("/leads")
		  public ResponseEntity<List<Leads>> getAllTutorials(@RequestParam(required = false) String title) {
		    try {
		      ...
		      if (title == null)
		    	  ...
		    	  leadsRepo.findByTitleContaining(title).forEach(tutorials::add);
	    ...
	    public ResponseEntity<Leads> updateLeads(@PathVariable(value = "id") Long leadstId,
	        ...
	        leads.setCompany_Name(leadsDetails.getCompany_Name());
