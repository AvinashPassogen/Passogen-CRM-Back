...
public class User {
	...
	private static final String DEFAULT_ROL = "USER";
	...
	private String rol = DEFAULT_ROL;
	...
	public User(Long id, String first_name, String last_name, String email, String username, String job_title,
